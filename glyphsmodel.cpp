...
QVariant GlyphsModel::headerData(int section, Qt::Orientation orientation, int role) const
{
...
QModelIndex GlyphsModel::index(int row, int column, const QModelIndex &parent) const
{
...
QModelIndex GlyphsModel::parent(const QModelIndex &index) const
{
    Q_UNUSED(index);
